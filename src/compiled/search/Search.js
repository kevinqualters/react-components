            ...
            return (
                React.createElement("div", {className: "search-component"}, 
                    React.createElement("div", {className: "input-group"}, 
                        ...
                        React.createElement("input", {ref: "searchInput", value: this.state.inputValue, type: "text", autoComplete: "off", placeholder: this.state.placeholder, disabled: this.state.disabled, 
                        onChange: this.onChange, 
                        onFocus: this.onFocus, 
                        onBlur: this.onBlur, 
                        onKeyDown: this.onInputKeyPress}
                        ), 
                        React.createElement("ul", {ref: "list", className: "autocomplete-list", 
